...
INSERT INTO users (id, username, password, email, display_name, student_id, role, login_type, created_at, updated_at) VALUES
-- Admin users (2)
(51, 'sarah.admin', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'sarah.anderson@pose.edu', 'Sarah Anderson', NULL, 'ADMIN', 'LOCAL', NOW(), NOW()),
(2, 'david.admin', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'david.thompson@pose.edu', 'David Thompson', NULL, 'ADMIN', 'LOCAL', NOW(), NOW()),

-- Instructors (8)
(3, 'michael.roberts', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'michael.roberts@pose.edu', 'Dr. Michael Roberts', NULL, 'INSTRUCTOR', 'LOCAL', NOW(), NOW()),
(4, 'jennifer.martin', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'jennifer.martin@pose.edu', 'Prof. Jennifer Martin', NULL, 'INSTRUCTOR', 'LOCAL', NOW(), NOW()),
(5, 'james.wilson', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'james.wilson@pose.edu', 'Dr. James Wilson', NULL, 'INSTRUCTOR', 'LOCAL', NOW(), NOW()),
(6, 'emily.davis', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'emily.davis@pose.edu', 'Dr. Emily Davis', NULL, 'INSTRUCTOR', 'LOCAL', NOW(), NOW()),
(7, 'robert.garcia', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'robert.garcia@pose.edu', 'Prof. Robert Garcia', NULL, 'INSTRUCTOR', 'LOCAL', NOW(), NOW()),
(8, 'linda.martinez', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'linda.martinez@pose.edu', 'Dr. Linda Martinez', NULL, 'INSTRUCTOR', 'LOCAL', NOW(), NOW()),
(9, 'william.brown', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'william.brown@pose.edu', 'Dr. William Brown', NULL, 'INSTRUCTOR', 'LOCAL', NOW(), NOW()),
(10, 'patricia.johnson', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'patricia.johnson@pose.edu', 'Prof. Patricia Johnson', NULL, 'INSTRUCTOR', 'LOCAL', NOW(), NOW()),

-- Students (40)
(11, 'alexander.nguyen', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'alexander.nguyen@student.pose.edu', 'Alexander Nguyen', '22000001', 'STUDENT', 'LOCAL', NOW(), NOW()),
(12, 'sophia.patel', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'sophia.patel@student.pose.edu', 'Sophia Patel', '22000002', 'STUDENT', 'LOCAL', NOW(), NOW()),
(13, 'ethan.kim', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'ethan.kim@student.pose.edu', 'Ethan Kim', '22000003', 'STUDENT', 'LOCAL', NOW(), NOW()),
(14, 'olivia.chen', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'olivia.chen@student.pose.edu', 'Olivia Chen', '22000004', 'STUDENT', 'LOCAL', NOW(), NOW()),
(15, 'noah.singh', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'noah.singh@student.pose.edu', 'Noah Singh', '22000005', 'STUDENT', 'LOCAL', NOW(), NOW()),
(16, 'emma.rodriguez', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'emma.rodriguez@student.pose.edu', 'Emma Rodriguez', '22000006', 'STUDENT', 'LOCAL', NOW(), NOW()),
(17, 'liam.lee', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'liam.lee@student.pose.edu', 'Liam Lee', '22000007', 'STUDENT', 'LOCAL', NOW(), NOW()),
(18, 'ava.jackson', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'ava.jackson@student.pose.edu', 'Ava Jackson', '22000008', 'STUDENT', 'LOCAL', NOW(), NOW()),
(19, 'lucas.taylor', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'lucas.taylor@student.pose.edu', 'Lucas Taylor', '22000009', 'STUDENT', 'LOCAL', NOW(), NOW()),
(20, 'isabella.white', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'isabella.white@student.pose.edu', 'Isabella White', '22000010', 'STUDENT', 'LOCAL', NOW(), NOW()),
(21, 'mason.harris', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'mason.harris@student.pose.edu', 'Mason Harris', '22000011', 'STUDENT', 'LOCAL', NOW(), NOW()),
(22, 'mia.thompson', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'mia.thompson@student.pose.edu', 'Mia Thompson', '22000012', 'STUDENT', 'LOCAL', NOW(), NOW()),
(23, 'jacob.anderson', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'jacob.anderson@student.pose.edu', 'Jacob Anderson', '22000013', 'STUDENT', 'LOCAL', NOW(), NOW()),
(24, 'charlotte.moore', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'charlotte.moore@student.pose.edu', 'Charlotte Moore', '22000014', 'STUDENT', 'LOCAL', NOW(), NOW()),
(25, 'daniel.clark', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'daniel.clark@student.pose.edu', 'Daniel Clark', '22000015', 'STUDENT', 'LOCAL', NOW(), NOW()),
(26, 'amelia.lopez', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'amelia.lopez@student.pose.edu', 'Amelia Lopez', '22000016', 'STUDENT', 'LOCAL', NOW(), NOW()),
(27, 'matthew.gonzalez', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'matthew.gonzalez@student.pose.edu', 'Matthew Gonzalez', '22000017', 'STUDENT', 'LOCAL', NOW(), NOW()),
(28, 'harper.hill', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'harper.hill@student.pose.edu', 'Harper Hill', '22000018', 'STUDENT', 'LOCAL', NOW(), NOW()),
(29, 'benjamin.wright', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'benjamin.wright@student.pose.edu', 'Benjamin Wright', '22000019', 'STUDENT', 'LOCAL', NOW(), NOW()),
(30, 'evelyn.scott', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'evelyn.scott@student.pose.edu', 'Evelyn Scott', '22000020', 'STUDENT', 'LOCAL', NOW(), NOW()),
(31, 'logan.green', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'logan.green@student.pose.edu', 'Logan Green', '22000021', 'STUDENT', 'LOCAL', NOW(), NOW()),
(32, 'abigail.adams', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'abigail.adams@student.pose.edu', 'Abigail Adams', '22000022', 'STUDENT', 'LOCAL', NOW(), NOW()),
(33, 'jackson.baker', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'jackson.baker@student.pose.edu', 'Jackson Baker', '22000023', 'STUDENT', 'LOCAL', NOW(), NOW()),
(34, 'ella.nelson', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'ella.nelson@student.pose.edu', 'Ella Nelson', '22000024', 'STUDENT', 'LOCAL', NOW(), NOW()),
(35, 'sebastian.carter', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'sebastian.carter@student.pose.edu', 'Sebastian Carter', '22000025', 'STUDENT', 'LOCAL', NOW(), NOW()),
(36, 'scarlett.mitchell', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'scarlett.mitchell@student.pose.edu', 'Scarlett Mitchell', '22000026', 'STUDENT', 'LOCAL', NOW(), NOW()),
(37, 'aiden.perez', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'aiden.perez@student.pose.edu', 'Aiden Perez', '22000027', 'STUDENT', 'LOCAL', NOW(), NOW()),
(38, 'victoria.roberts', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'victoria.roberts@student.pose.edu', 'Victoria Roberts', '22000028', 'STUDENT', 'LOCAL', NOW(), NOW()),
(39, 'carter.turner', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'carter.turner@student.pose.edu', 'Carter Turner', '22000029', 'STUDENT', 'LOCAL', NOW(), NOW()),
(40, 'grace.phillips', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'grace.phillips@student.pose.edu', 'Grace Phillips', '22000030', 'STUDENT', 'LOCAL', NOW(), NOW()),
(41, 'wyatt.campbell', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'wyatt.campbell@student.pose.edu', 'Wyatt Campbell', '22000031', 'STUDENT', 'LOCAL', NOW(), NOW()),
(42, 'chloe.parker', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'chloe.parker@student.pose.edu', 'Chloe Parker', '22000032', 'STUDENT', 'LOCAL', NOW(), NOW()),
(43, 'jack.evans', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'jack.evans@student.pose.edu', 'Jack Evans', '22000033', 'STUDENT', 'LOCAL', NOW(), NOW()),
(44, 'zoey.edwards', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'zoey.edwards@student.pose.edu', 'Zoey Edwards', '22000034', 'STUDENT', 'LOCAL', NOW(), NOW()),
(45, 'owen.collins', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'owen.collins@student.pose.edu', 'Owen Collins', '22000035', 'STUDENT', 'LOCAL', NOW(), NOW()),
(46, 'lily.stewart', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'lily.stewart@student.pose.edu', 'Lily Stewart', '22000036', 'STUDENT', 'LOCAL', NOW(), NOW()),
(47, 'grayson.sanchez', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'grayson.sanchez@student.pose.edu', 'Grayson Sanchez', '22000037', 'STUDENT', 'LOCAL', NOW(), NOW()),
(48, 'hannah.morris', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'hannah.morris@student.pose.edu', 'Hannah Morris', '22000038', 'STUDENT', 'LOCAL', NOW(), NOW()),
(49, 'luke.ramirez', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'luke.ramirez@student.pose.edu', 'Luke Ramirez', '22000039', 'STUDENT', 'LOCAL', NOW(), NOW()),
(50, 'aria.james', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'aria.james@student.pose.edu', 'Aria James', '22000040', 'STUDENT', 'LOCAL', NOW(), NOW());
