...
-- Admin users (2)
(1, 'sarah.admin', '$2a$12$Iy6.4cKcgUtFOMeUGRTuw.IPoVuBvPS2e8a4qbz/mzdB7chDFbJ2S', 'sarah.anderson@pose.edu', 'Sarah Anderson', 'ADMIN', 'ACTIVE', 'LOCAL', NOW(), NOW()),
...
-- Tasks (40 entries) - Note: assigned_to_id removed, using task_assignees junction table instead
...
-- Task Assignees (40 entries) - Junction table for many-to-many relationship
